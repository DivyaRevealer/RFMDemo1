...
// helper: compute allowed options given current selections
...
// whenever any geo filter changes, drop invalid selections automatically
useEffect(() => {
          ...
          <Row gutter={16}>
            ...
            <Col span={8}>
              <Form.Item noStyle shouldUpdate={(prev, cur) =>
                ...
                {() => {
                  const { allowedBranches } = computeGeoOptions();
                  return (
            ...
            <Col span={8}>
              <Form.Item noStyle shouldUpdate={(prev, cur) =>
                ...
                {() => {
                  const { allowedCities } = computeGeoOptions();
                  return (
            ...
            <Col span={8}>
              <Form.Item noStyle shouldUpdate={(prev, cur) =>
                ...
                {() => {
                  const { allowedStates } = computeGeoOptions();
                  return (
